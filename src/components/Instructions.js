...
const Instructions = () => {
  ...
  const playText = (
    <p id="instructions-text">
      ...
      <br /> <br />
      In the event of a tie, yours and the computer's top cards are removed from
      their decks and added to a "tie deck". The winner of the next round wins
      the tie cards as well as the card they beat to break the tie. If the next
      round results in another tie, these cards are also added to the tie deck
      and play contintues in this fashion until the tie is broken or one player
      runs out of cards.
      <br /> <br />
  ...
  const createText = (
    <p id="instructions-text">
      ...
      <br /> <br />
      Finally, choose a nickname and alignment for your animal. These don't have
      any bearing on the gameplay, they just add a bit of extra colour to your
      card.
      <br /> <br />
